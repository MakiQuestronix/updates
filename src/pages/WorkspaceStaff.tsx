  ...
  return (
    <div>
        ...
        <div className="flex flex-row gap-4 mt-6 border border-[#E0E0E0] rounded-md p-2 px-2 items-start">
          <div className="pt-4 pl-10 flex gap-4">
            ...
            <div>
              ...
              <p>
                <span className="text-sm"></span> {sentenceCase(member.role)}
              </p>
              <p>
                ...
                <div
                  className={`size-4 rounded-full shadow-[inset_0_4px_4px_rgba(255,255,255,1)] ${
                    member.status === "ACTIVE"
                      ? "bg-[#0EFC4E] border border-[#0EFC4E]"
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`px-4 py-1.5 rounded-md text-sm transition-colors font-semibold  ${
                activeTab === tab.value ? "bg-white" : "bg-[#F7F7F7] text-black"
              }`}
            >
              {tab.label}
            </button>
                  ...
                  <div className="flex flex-col gap-6 w-2/5">
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="bg-[#3d3d3d] rounded-xl p-5">
                        ...
                        <p className="font-bold text-4xl mt-2 text-white">
      ...
      <div className="flex gap-6 justify-center items-center my-4">
        <button className="w-45 px-4 py-2 border border-[#e0e0e0] shadow rounded-md text-sm hover:bg-[#e0e0e0] hover:cursor-pointer">
          Edit Role
        </button>
        <button className="w-45 px-4 py-2 border border-[#e0e0e0] shadow rounded-md text-sm hover:bg-red-500 hover:cursor-pointer">
          Remove Member
        </button>
      </div>
    </div>
