...
function ViewActions({
  ...
  return (
    <div
      ...
      className="fixed z-50 w-44 bg-white border border-borders rounded-xl shadow-lg py-2"
    >
      <Link
        to={`/Layout/knowledges/${id}/${_id}`}
        ...
        <div className="py-2 px-4 overflow-y-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2 py-4">
            <div className="flex flex-col gap-1">
              ...
              <select className="border border-borders rounded-md p-2 shadow">
                <option>All</option>
            ...
            <div className="flex flex-col gap-1 col-span-2">
              ...
              <div className="flex flex-col sm:flex-row gap-2 items-center">
                <input
                  type="date"
                  className="border border-borders rounded-md p-2 shadow text-sm w-full"
                />
            ...
            <div className="flex flex-col gap-1">
              ...
              <button className="text-sm bg-first rounded-md p-2 border border-borders shadow">
                Clear Filters
              </button>
            </div>
            <div className="flex flex-col gap-1 col-span-2">
              <p className="invisible">.</p>
              <div className="flex items-center text-sm border border-borders rounded-md p-2 shadow">
              ...
              <table className="w-full border-separate border-spacing-0 min-w-150">
                <thead>
                  <tr className="font-semibold text-fourth text-center text-sm">
                    <th className="p-2 px-4 text-left border-t border-l border-borders rounded-tl-md">
                      Name
                    </th>
                    <th className="p-2 border-t border-borders">Type</th>
                    <th className="p-2 border-t border-borders">Size</th>
                    <th className="p-2 border-t border-borders">Owner</th>
                    <th className="p-2 border-t border-borders">Status</th>
                    <th className="p-2 px-4 border-t  border-borders ">
                      Approval
                    </th>
                    <th className="p-2 px-4 border-t  border-borders">Date</th>
                    <th className="p-2 px-4 border-t border-r border-borders rounded-tr-md">
                      Actions
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {currentDocuments.filter((dc) => dc.docStatus === "Active")
                    ...
                    <tr>
                      <td
                        colSpan={8}
                        className="border border-borders rounded-b-md"
                      >
                      ...
                      .map((dc, i, arr) => {
                        ...
                        return (
                          <tr key={dc.id} className="text-center text-sm">
                            <td
                              className={`p-2 px-4 border-l border-t text-start border-borders ${isLast ? "border-b rounded-bl-md" : ""}`}
                            >
                              {dc.name}
                            </td>
                            <td
                              className={`p-2 border-t text-center border-borders ${isLast ? "border-b" : ""}`}
                            >
                              {dc.type}
                            </td>
                            <td
                            ...
                            <td
                              className={`p-2 border-t border-borders ${isLast ? "border-b" : ""} `}
                            >
                              <StatusBadge
                                type="status"
                                value={dc.status}
                            ...
                            <td
                              className={`border-t border-r border-borders ${isLast ? "border-b rounded-br-md" : ""}`}
                            >
              ...
              <table className="w-full border-separate border-spacing-0 min-w-150">
                <thead>
                  <tr className="font-semibold text-fourth text-center text-sm">
                    ...
                    <th className="p-2 border-t border-borders">Type</th>
                    <th className="p-2 border-t border-borders">Size</th>
                    <th className="p-2 border-t border-borders">Archived by</th>
                    <th className="p-2 border-t border-borders">
                      Archived Date
                    </th>
                    <th className="p-2 px-4 border-t border-r border-borders rounded-tr-md">
                      Actions
                      ...
                      .map((dc, i, arr) => {
                        ...
                        return (
                          <tr key={dc.id} className="text-center text-sm">
                            ...
                            <td
                              className={`border-t border-r border-borders py-2 ${isLast ? "border-b rounded-br-md" : ""}`}
                            >
